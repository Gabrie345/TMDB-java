					...
					<div class="card-body">
						<div class="row">
							<div class="col-12 col-sm-8 mb-3">
								<div class="row ">
									<div class="col-md-6">
										Titulo Original: <span>${filme.getTituloOriginal()}</span> 
									</div>
									<div class="col-md-6">
										Data da lançamento: <span>${filme.getDataLancamento()}</span>
									</div>
								</div>
								<div>Descrição</div>
								<div>
									<textarea class="form-control" id="disabledInput" rows="10"
										disabled="">${filme.getDescricao()}</textarea>
								</div>
							</div>
							...
							<div>
							<p>Avaliação:&#x2B50;<span>${filme.getVotos()}</span></p>
							</div>										
								</div>
							</div>
						</div>
